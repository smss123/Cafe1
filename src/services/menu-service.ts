...
export class MenuService implements IService {
    ...
    getAllThemes = (): Array<any> => {
      return [
        {"title" : "الرئيسية", "theme"  : "listViews",  "icon" : "icon-format-align-justify", "listView" : true, "component": "","page":"ArhomePage"}
        // {"title" : " Views", "theme"  : "listViews",  "icon" : "icon-format-align-justify", "listView" : true, "component": ""},
